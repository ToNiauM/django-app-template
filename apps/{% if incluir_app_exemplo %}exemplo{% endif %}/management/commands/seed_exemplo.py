"""Comando para popular dados de demonstração no app exemplo removível."""
...
EXEMPLOS_TITULOS = [
    ...
    ("Assinatura de plataforma corporativa de BI e analytics", "Licenciamento anual de ferramentas de visualização e apoio à decisão.", CategoriaChoices.RECURSOS, StatusChoices.CONCLUIDO, Decimal("48750.00"), -15),
    ...
    ("Auditoria contábil independente do exercício anterior", "Contratação de empresa de auditoria para emissão de parecer sobre as demonstrações.", CategoriaChoices.RECURSOS, StatusChoices.CONCLUIDO, Decimal("78000.00"), -10),
    ...
    ("Elaboração do relatório de gestão e sustentabilidade", "Diagramação, revisão técnica e publicação do balanço social e de recursos.", CategoriaChoices.ADMINISTRATIVO, StatusChoices.CONCLUIDO, Decimal("24500.00"), -5),
    ...
    ("Serviços de tradução e revisão de publicações técnicas", "Versão bilíngue de manuais e pronunciamentos contábeis internacionais.", CategoriaChoices.RECURSOS, StatusChoices.CANCELADO, Decimal("19800.00"), -30),
    ...
    ("Renovação da apólice de seguro patrimonial", "Cobertura de equipamentos de TI, instalações e responsabilidade civil.", CategoriaChoices.RECURSOS, StatusChoices.CONCLUIDO, Decimal("52000.00"), -15),
...
class Command(BaseCommand):
    help = "Popula dados de demonstração para o app exemplo removível"
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(f"Sucesso: {criados} itens de demonstração foram criados.")
        )
