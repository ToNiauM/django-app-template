...
- [x] 07-03-PLAN.md — Encaixe da navegação: `_nav_dominio.html`, `{% item_nav %}` e `_skip_if_exists`

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 07-04-PLAN.md — `core/tema.py`: a família de marca deriva de `COR_PRIMARIA` em runtime, com prova executável

**Wave 5** *(blocked on Wave 4 completion)*

- [x] 07-05-PLAN.md — Tema escuro: script síncrono, controle de 3 estados e elevação no `core`

**Wave 6** *(blocked on Wave 5 completion)*

- [x] 07-06-PLAN.md — Gráficos sem hex, paleta servida pelo Django e elevação no app exemplo
...
- [x] 07-13-PLAN.md — G-03: `seq-750`, quarto degrau real da rampa sequencial, no lugar do token de fundo `brand-tint`
...
| 7. Herdar o design system do PCA | 13/14 | In Progress|  |
